...
if (isset($_POST['btnCalcular'])){
    ...
    if(SomarValorFinal($valor1, $valor2, $valor3, $valor4, $valor5, $valor6, $valor7, $valor8, $valor9, $valor10) == 0){
        $msg = 'Preencher campos obrigatórios!';
    }else{
        $resultado = SomarValorFinal($valor1, $valor2, $valor3, $valor4, $valor5, $valor6, $valor7, $valor8, $valor9, $valor10);
    }
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    ...
    <form action="pagina_6.php" method="POST">
        <label>Valor 1:</label>
